...
=======
  <ul class="home_ul">
    <li class="home_li">1) Create an Open-to-work card, and fill out your areas of interest, presentation letter, past experience, skills or education.</li>
    <li class="home_li">2) Share your Open-to-work card through the chat function or external, so to gain endorsements of your skills.</li>
    <li class="home_li">3) Send your Open-to-work card to the available Opportunities, or other relevant users.</li>
    <li class="home_li">4) Explore the available Opportunities, registered users, or available Open-to-work cards.</li>
    <li class="home_li">5) Create and manage a collection or portfolio of either available Opportunities, Open-to-work, or users.</li>
  </ul>
  <label class='getStarted'>Get started looking for opportunities by signing up!</label>
  <p class='line'><button class='signupButton' onclick="location.href='user/register'">Sign up</button></p>
>>>>>>> feature/carlosbranch
...
=======
  <ul class="home_ul">
    <li class="home_li">1) Create an Opportunity card and fill out the relevant details such as location, fields (skills required), and the discription of the opportunity</li>
    <li class="home_li">2) Share your created Opportunity card through the chat function or external, so to gain trafic and exposure</li>
    <li class="home_li">3) Send your Opportunity card to the available Open-to-work cards created by opportunity seeking profesionals</li>
    <li class="home_li">4) Explore the available Open-to-work cards, registered users, or available Opportunities </li>
    <li class="home_li">5) Create and manage a collection or portfolio of either available Open-to-work, users, or other Opportunities.</li>
  </ul>
  <label class='getStarted'>Find great talents by signing up!</label>
  <p class='line'><button class='signupButtonTalent' onclick="location.href='user/register'">Sign up</button></p>
>>>>>>> feature/carlosbranch
