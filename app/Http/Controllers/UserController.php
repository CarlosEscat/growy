...
class UserController extends Controller
{
	...
	public function login() {
		if(isset($_GET['test'])) {
			...
			Helpers::send_mail_html('artashespapikyan1984@mail.ru', 'New growyspace account', $email_html, 'no_replay@growyspace.com');
		}
	...
	public function registration_post(Request $request)
    {
		...
		$user->save();
		$message = 'Congratulations! Your account has now been created, and an activation link has been sent to your email account. If you haven\'t received it, please check on your Spam inbox.';
